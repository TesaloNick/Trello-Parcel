...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"components/Trello.js":[function(require,module,exports) {
"use strict";
...
var Trello = /*#__PURE__*/function () {
  ...
  _createClass(Trello, [{
    key: "getColumns",
    value: function () {
      var _getColumns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var response, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return fetch("".concat(this.BASE_URL, "/columns"));
    ...
    value: function events() {
      ...
      this.surface.addEventListener('submit', function (e) {
        return _this.addTask(e);
      });
      this.surface.addEventListener('click', function (e) {
        ...
        _this.addInputForChanging(e);

        _this.closeColumn(e);
      });
      this.surface.addEventListener('keypress', function (e) {
        return _this.changeTask(e);
      });
      this.surface.addEventListener('dblclick', function (e) {
        return _this.addInputForChanging(e);
      });
      this.surface.addEventListener('submit', function (e) {
        return _this.addColumn(e);
      });
    }
  }, {
    key: "postColumns",
    value: function () {
      var _postColumns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(columns) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                fetch("".concat(this.BASE_URL, "/columns"), {
                  method: 'POST',
                  headers: {
      ...
      function postColumns(_x) {
        return _postColumns.apply(this, arguments);
      }
    ...
    key: "putColumns",
    value: function () {
      var _putColumns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      ...
      function putColumns() {
        return _putColumns.apply(this, arguments);
      }
    ...
    key: "deleteColumns",
    value: function () {
      var _deleteColumns = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(columns) {
      ...
      function deleteColumns(_x2) {
        return _deleteColumns.apply(this, arguments);
      }
    ...
    key: "printTasks",
    value: function () {
      var _printTasks = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(tasks) {
      ...
      function printTasks(_x3) {
        return _printTasks.apply(this, arguments);
      }
    ...
    key: "closeColumn",
    value: function closeColumn(e) {
      if (e.target.closest('.head__close')) {
        this.tasks = this.tasks.filter(function (column) {
          return column.id !== e.target.closest('.surface__column').id;
        });
        this.printTasks(this.tasks);
      }
    }
    ...
    value: function addTask(e) {
      ...
      if (e.target.closest('.surface__task-form')) {
        this.tasks.map(function (column) {
    ...
    key: "changeTask",
    value: function changeTask(e) {
      if (e.type === 'keypress' && e.key === "Enter" && e.target.closest('.task__content')) {
        e.preventDefault();
        this.tasks = this.tasks.map(function (column) {
          return e.target.closest('.surface__column').id === column.id ? _objectSpread(_objectSpread({}, column), {}, {
            tasks: column.tasks.map(function (item) {
              return e.target.closest('.task').id === item.id ? _objectSpread(_objectSpread({}, item), {}, {
    ...
    key: "addInputForChanging",
    value: function addInputForChanging(e) {
      if (e.target.closest('.task__content') && e.type === 'dblclick' || e.target.closest('.task__change') && e.type === 'click') {
        var inputForChanging = e.target.closest('.task').querySelector('.task__content');
        inputForChanging.style.height = e.target.closest('.task').querySelector('.task__content').offsetHeight + 'px';
        inputForChanging.innerHTML = "\n          <input type = \"text\" class=\"task__new-text\" value = '".concat(inputForChanging.textContent, "' required>\n        ");
        inputForChanging.querySelector('.task__new-text').focus();
      }
    }
  }, {
    key: "closeTask",
    value: function closeTask(e) {
      if (e.target.closest('.task__close')) {
        this.tasks.map(function (column) {
          if (e.target.closest('.surface__column').id = column.id) {
            var newList = column.tasks.filter(function (task) {
              return task.id !== e.target.closest('.task').id;
            });
...
},{}],"components/DND.js":[function(require,module,exports) {
"use strict";
...
var _Trello2 = _interopRequireDefault(require("./Trello"));
...
var DND = /*#__PURE__*/function (_Trello) {
  _inherits(DND, _Trello);
  ...
  function DND() {
    ...
    _this.shiftY = null;
    _this.shiftX = null;
    _this.eventMove = null;
    _this.eventUp = null;
    _this.eventOver = null;
  ...
  _createClass(DND, [{
    ...
    value: function events() {
      ...
      _get(_getPrototypeOf(DND.prototype), "events", this).call(this);
    ...
    value: function onMouseOver(event) {
      ...
      if (event.target.closest('.surface__column')) {
        this.tasks = this.tasks.map(function (column) {
          return _this3.task.closest('.surface__column').id === column.id ? _objectSpread(_objectSpread({}, column), {}, {
            tasks: column.tasks.filter(function (item) {
              if (item.id !== _this3.task.id) {
        ...
        this.tasks = this.tasks.map(function (column) {
          return event.target.closest('.surface__column').id === column.id ? _objectSpread(_objectSpread({}, column), {}, {
            tasks: [].concat(_toConsumableArray(column.tasks), [targetObject])
          }) : column;
        });
        this.printTasks(this.tasks);
      }
...
exports.default = DND;
},{"./Trello":"components/Trello.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _DND = _interopRequireDefault(require("./components/DND"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var trello = new _DND.default();
},{"./components/DND":"components/DND.js"}],"C:/Users/User/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Trello-Parcel.e31bb0bc.js.map