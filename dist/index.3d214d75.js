...
})({"l0tTf":[function(require,module,exports) {
"use strict";
...
var _dnd = require("./components/DND");
var _dndDefault = parcelHelpers.interopDefault(_dnd);
let trello = new (0, _dndDefault.default)();

},{"./components/DND":"dxYVh","@parcel/transformer-js/src/esmodule-helpers.js":"az0mL"}],"dxYVh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _trello = require("./Trello");
var _trelloDefault = parcelHelpers.interopDefault(_trello);
class DND extends (0, _trelloDefault.default) {
    constructor(){
        super();
        this.task = null;
        ...
        if (event.target.closest(".surface__column")) {
            this.tasks = this.tasks.map((column)=>this.task.closest(".surface__column").id === column.id ? {
                    ...
                    tasks: column.tasks.filter((item)=>{
                        if (item.id !== this.task.id) return item.id !== this.task.id;
                        else targetObject = item;
                    })
                } : column);
...
},{"./Trello":"ce7tP","@parcel/transformer-js/src/esmodule-helpers.js":"az0mL"}],"ce7tP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Trello {
    constructor(){
    ...
    addTask(e) {
        ...
        if (e.target.closest(".surface__task-form")) {
            this.tasks.map((column)=>{
                if (e.target.closest(".surface__column").id == column.id) column.tasks.push({
    ...
    changeTask(e) {
        if (e.type === "keypress" && e.key === "Enter" && e.target.closest(".task__content")) {
            ...
            this.tasks = this.tasks.map((column)=>e.target.closest(".surface__column").id === column.id ? {
                    ...column,
                    tasks: column.tasks.map((item)=>e.target.closest(".task").id === item.id ? {
                            ...item,
...
},{}]},["l0tTf","bB7Pu"], "bB7Pu", "parcelRequire341c")
